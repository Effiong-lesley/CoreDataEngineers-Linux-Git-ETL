...
#               to move.
#
# Usage       : ./move_csv_json.sh <source_folder> [destination_parent]
#
...
#                                    directory)
#
# Examples    : ./move_csv_json.sh ./sample_data
#               ./move_csv_json.sh ./sample_data ./archive
#===============================================================================
...
if [ ${#FILES[@]} -eq 0 ]; then
    log "No CSV or JSON files found in '$SOURCE_DIR'. Nothing was moved."
    exit 0
fi
